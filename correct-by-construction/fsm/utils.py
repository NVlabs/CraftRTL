...
General re-usable code for each problem.

Most problems require specific modification. Refer to each problem specific implementation under templates.
"""
...
def sort_lines(input_string):
    """
    The generated representation would sometimes be random. We intend to include such variance.
    This function would sort the lines, so as to decontaminate with benchmark.
    """
